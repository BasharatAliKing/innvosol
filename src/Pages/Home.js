          ...
          <MainPara mainpara="We are committed to our vision of providing high-level service and value to clients through enhanced services that include diligence."/>
           ...
           <div className="row">
              <div className="col-lg-4 col-md-6">
                <ServicesCards img={<RiComputerLine size="30px"  />} title="Web Design & Development" para="We’ve reached significant milestones in providing the best web development services." />
              </div>
              <div className="col-lg-4 col-md-6">
                <ServicesCards img={<MdPhoneAndroid size="30px" />} title="Mobile App Development" para="Need a mobile app developed? We develop mobile apps for IOS and Android Operating System." />
              </div>
              <div className="col-lg-4 col-md-6">
                <ServicesCards img={<AiFillGift size="30px" />} title="E-Commerce" para="We are thought leaders in creating rewarding through responsive web design and emerging UX technologies." />
              </div>
              <div className="col-lg-4 col-md-6">
                <ServicesCards img={<FaPaintBrush size="30px" />} title="Brand Strategy & UI/UX" para="We have skilled graphic designers who can portray and develop your ideas perfectly." />
              </div>
              <div className="col-lg-4 col-md-6">
                <ServicesCards img={<HiUserGroup size="30px"  />} title="Staff Augmentation" para="Hiring a skilled developer at a reasonable price takes months, not weeks." />
              </div>
              <div className="col-lg-4 col-md-6">
                <ServicesCards img={<FaCloudDownloadAlt size="30px"  />}title="Cloud Application Development" para="To build cloud apps, use affordable and popular cloud tools that offer flexibility, security, and reliability." />
              </div>
            </div>
           </div>
          </div>
   ...
   <DiscussCard title="Discussing a Project?" para="We’re happy to help you. Send us a message for a free online meeting with the top software development company in the USA, and we’ll make a customized plan for your project." btn="Let's Talk" />
     ...
     <div id="improve">
      <div className="container">
        <div className="row">
          <div className="col-12">
            <MainHeading mainheading="We help you strengthen and improve your abilities." />
          </div>
